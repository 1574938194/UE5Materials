...
void AueTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AueTestCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AueTestCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AueTestCharacter::OnResetVR);
}


void AueTestCharacter::OnResetVR()
{
	// If ueTest is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in ueTest.Build.cs is not automatically propagated
...
void AueTestCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AueTestCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
